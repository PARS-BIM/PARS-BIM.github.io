---
title: Vertical cross multiple elements - Fixed distance
---

# Vertical cross multiple elements - Fixed distance
With this command, you can easily resolve clashes between two elements without the need to create additional sections or use cutting and remodeling tools. This command keeps the main route elevation and just cross with fixed distance for multiple elements.


## Steps

First in the opened window, you have two options. If you want to select an entire element as the obstacle, click “Select Element”. If you prefer to define the crossing logic based on a surface, choose “Select Face”.
...
Next, first select the element as obstacle and then select the elements where you want the break to occur and that should pass over the obstructing element. 
...
Also specify the distance that you want to consider as the cross in the "Distance" section
...
<img src="https://pars-bim.github.io/docs/Assets/Vcross-fixed-distance.jpg" alt="Vertical cross options - fixed distance" width="500">
